...
public class IndoorDirections {
    ...
    @Test
    public void indoorDirections() throws InterruptedException {
        ViewInteraction appCompatAutoCompleteTextView = onView(
                allOf(withId(R.id.search_bar),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatAutoCompleteTextView.perform(typeText("h-1"), closeSoftKeyboard());

        onData(anything()).inRoot(RootMatchers.isPlatformPopup()).atPosition(4).perform(click());

        ViewInteraction appCompatAutoCompleteTextView2 = onView(
                allOf(withId(R.id.starting_location),
                        childAtPosition(
                                childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatAutoCompleteTextView2.perform(typeText("h-8"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatButton = onView(
                allOf(withId(R.id.nextStep), withText("Next Step"),
                        childAtPosition(
                                childAtPosition(
